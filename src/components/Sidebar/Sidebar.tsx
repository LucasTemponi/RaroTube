  ...
  return (
    <div className='flex flex-row relative w-full '>
      {closeSidebar && (
        <>
          <div
            className={`flex flex-col fixed pt-20 z-10 overflow-auto w-full md:bg-black-rgba xl:w-64 h-auto xl:bg-gray-50 bg-gray-50 transition-all duration-200 ease-linear ${animation} `}
          >
              ...
              <div className='py-2 overflow-auto px-3 bg-gray-50 dark:bg-gray-800'>
                <ul className=' space-y-2 items-center '>
                  <div className='text-center'>
                    <span className='items-center pl-4 w-full text-base font-bold text-gray-700 rounded-lg dark:text-gray-100'>
                      Não é nosso aluno?
                    </span>
                  </div>
                  <a
                  ...
                  >
                    ...
                    <span className='cursor-pointer items-center pl-4 w-full text-base font-bold text-raro-cobalto rounded-lg dark:text-gray-100'>
                      Matricule-se
                    </span>
                  </a>
                </ul>
          ...
          <div
            className={`w-80 dark:bg-gray-800 transition-all duration-400 ease-in-out ${animation}`}
          ></div>
        </>
      )}
      {children}
