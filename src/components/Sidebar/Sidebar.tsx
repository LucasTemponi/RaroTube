...
export const SideBar: React.FC<Props> = ({ children, isOpen }) => {
    ...
    return (
        <div className="flex flex-row z-10 w-full " >
            {closeSidebar &&
                <div className={`flex flex-col absolute xl:relative z-20 w-full md:w-1/2 xl:w-64 min-h-screen bg-gray-50 transition-all duration-200 ease-linear ${animation} `}>
                        ...
                        <div className="py-2 px-3 bg-gray-50 dark:bg-gray-800">
                            <ul className='  space-y-2 items-center '>
                                <div className='text-center'>
                                    <span className="items-center pl-4 w-full text-base font-bold text-gray-700 rounded-lg dark:text-white dark:hover:bg-gray-700">
                                        Não é nosso aluno?
                                    </span>
                                </div>
                                <a className='flex items-center p-2 hover:bg-blue-100 rounded-lg cursor-pointer' href='https://www.raroacademy.com.br/' rel='noreferrer' target="_blank">
