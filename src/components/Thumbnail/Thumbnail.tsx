...
import { Estrelinha } from '../../assets/Estrelinha';
...
export const Thumbnail: React.FC<thumbnailProps> = props => {
  ...
  return (
    <article
      className={`flex flex-col bg-white items-center transform ${props.hover ? 'hover:scale-110' : ''
      ...
      <div className='relative '>
        ...
        <video
          className='rounded-t-md object-fill aspect-video'
        ...
        {authContext.estaAutenticado ?
              ...
              fill='none'
              viewBox='0 0 24 24'
              onClick={event=>favoriteVideo(event)}
            >
              <path
                  stroke='currentColor'
                  strokeLinecap='round'
