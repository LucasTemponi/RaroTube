              ...
              <ul className='  space-y-2 items-center '>
                <Link to={'/'}>
                  <a className='flex items-center p-2 hover:bg-blue-100 rounded-lg'>
                    ...
                    <span className=" cursor-pointer items-center pl-4 w-full text-base font-bold text-raro-cobalto rounded-lg dark:text-white dark:hover:bg-gray-700">Home</span>
                  </a>
                </Link>
              </ul>
              <div className='w-full px-6 pt-4'>
